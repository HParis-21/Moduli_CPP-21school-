...
ClapTrap::~ClapTrap()
{
	std::cout << "Destructor called(ClapTrap): " << _name << std::endl;
}

ClapTrap::ClapTrap() : _name("ClapTrap"), _hitpoints(10), _enerpoints(10)
{
	_attackdam = 0;
	std::cout << "Default constructor called(ClapTrap): " << _name << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _hitpoints(10), _enerpoints(10), _attackdam(0)
{
	this->_name = name;
	std::cout << "Constructor called(ClapTrap): " << _name << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << _name << " " << _hitpoints << " hitpoints has been left" << std::endl;
}

void ClapTrap::beRepaired(unsigned int amount)
{
	std::cout << _name << " was repaired, " << amount << " points was used" << std::endl;
	_hitpoints += amount;
	std::cout <<  _name << " " << _hitpoints << " hp has been left" << std::endl;
}